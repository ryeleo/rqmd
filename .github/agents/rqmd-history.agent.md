...
Use this agent when the key question is historical state, branching, replay planning, or safe recovery rather than current implementation.
...
Execution contract:
- Start with `rqmd --history`, `rqmd --timeline`, or detached rqmd-ai exports before considering recovery actions.
