...
- Changed shared interview group ordering plus bootstrap-chat, starter-init, and legacy-init interview labels, prompts, grouping, selection defaults, and option sets to load from packaged init YAML instead of hard-coded `rqmd-ai` Python dicts.
