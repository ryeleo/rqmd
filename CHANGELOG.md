...
- Added proposed backlog requirements for opening the current requirement in VS Code from the interactive UI, opening linked requirement references directly from interactive requirement detail views, and for first-class dual support of user-story plus Given/When/Then requirement blocks, including explicit rqmd-ai guidance to encourage keeping both styles aligned.
