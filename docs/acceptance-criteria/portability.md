...
### AC-ACCLI-PORTABILITY-001: Configurable repo root
- **Status:** 🔧 Implemented
...
### AC-ACCLI-PORTABILITY-002: Configurable criteria directory
- **Status:** 🔧 Implemented
...
### AC-ACCLI-PORTABILITY-003: Default conventions
- **Status:** 🔧 Implemented
- Given no portability flags are provided
- When command runs
- Then repo root defaults to current directory
- And criteria directory defaults to docs/acceptance-criteria.

### AC-ACCLI-PORTABILITY-004: Stable relative source display
- **Status:** 🔧 Implemented
...
### AC-ACCLI-PORTABILITY-005: Non-project-specific assumptions
- **Status:** 🔧 Implemented
...
### AC-ACCLI-PORTABILITY-006: Optional future config file support
- **Status:** 💡 Proposed
...
### AC-ACCLI-PORTABILITY-007: Status customization config location and precedence
- **Status:** 💡 Proposed
